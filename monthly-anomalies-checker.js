         ...
         * 3. Update the TARGET_CONVERSIONS array with the EXACT names of the
          *    conversion actions you want to track (Case-Sensitive).
           * 4. Update the EMAIL_RECIPIENTS array with your team's email addresses.
            * 5. Schedule this script to run Monthly (e.g., on the 1st or 2nd of the month).
             * =======================================================================
              */
...
function main() {
  ...
  // Determine current month tab name (e.g., "July 2026")
  var months = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
  var currentDate = new Date();
  var tabName = months[currentDate.getMonth()] + " " + currentDate.getFullYear();

  // Build the dashboard in the Google Sheet
  writeAnomaliesToSheet(ss, tabName, performanceAnomalies);
...
function writeAnomaliesToSheet(ss, tabName, anomalies) {
  var sheet = ss.getSheetByName(tabName);
  if (!sheet) {
    sheet = ss.insertSheet(tabName);
    sheet.appendRow(["Campaign Name", "KPI Metric", "MoM Shift", "This Month", "Last Month", "Timestamp Logged", "Raw Shift %", "Chart Label"]);
  }
